...
# Admin User
MONGODB_ADMIN_USER=${MONGODB_ADMIN_USER:-"fas_admin"}
MONGODB_ADMIN_PASS=${MONGODB_ADMIN_PASS:-"password"}
 
# Application Database User
MONGODB_APPLICATION_DATABASE=${MONGODB_APPLICATION_DATABASE:-"fas"}
MONGODB_APPLICATION_USER=${MONGODB_APPLICATION_USER:-"fas_admin"}
MONGODB_APPLICATION_PASS=${MONGODB_APPLICATION_PASS:-"password"}
...
if [ "$MONGODB_APPLICATION_DATABASE" != "fas_admin" ]; then
